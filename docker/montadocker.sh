...
docker run -d -p 9070:80 -v /home/MTTO-TIENDA/cm-regalonatural/www:/var/www/html --name cm-regalonatural-www -h cm-regalonatural --link cm-regalonatural-bbdd:db vicsoft01/ubuntu18.04-apache2.2-php7.3.11
